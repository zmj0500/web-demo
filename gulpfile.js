...
//模块
,mods = 'laytpl,laypage,laydate,jquery,layer,element,upload,form,tree,table,carousel,util,flow,layedit,code,test222'
...
gulp.task('bify',function(){
  return gulp.src(['script/jquery-1.9.1.min.js','script/base.js'])
      .pipe(concat('base.js'))
